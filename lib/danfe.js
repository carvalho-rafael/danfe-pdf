...
const { formatarDinheiro, formatarHora, formatarData } = require('./util/formatter')
...
var Danfe = (function() {
    ...
    Danfe.prototype.comModalidadeDoFrete = function(_modalidadeDoFrete) {
        if([
            ...
            'porContaDoRemetenteProprio',
            'porContaDoDestinatarioProprio',
            'porContaDeTerceiros',
    ...
    Danfe.prototype.getModalidadeDoFreteFormatada = function() {
        return {
            ...
            porContaDoRemetente: '(0) Remetente',
            porContaDoDestinatario: '(1) Destinatário',
            porContaDoRemetenteProprio: '(3) Remetente',
            porContaDoDestinatarioProprio: '(4) Destinatário',
