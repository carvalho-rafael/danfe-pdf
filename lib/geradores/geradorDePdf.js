...
module.exports = function(danfe, args, callback) {
    ...
    function desenharPagina() {
        ...
        normal([
            ...
            destinatario.getEndereco().getSegundaLinha(),
        ...
        var temLogotipo = emitente.getLogotipo(),
            ...
            identificacaoDoEmitenteX = temLogotipo ? 1.5 : 1.5,
        ...
        if(temLogotipo) {
            ...
            pdf.image(caminhoDoLogotipo, margemEsquerda + args.ajusteX + 4.5 + identificacaoDoEmitenteLargura, margemTopo + args.ajusteY + args.ajusteYDoLogotipo + 78, {
                fit: [60, 60]
            });
        }
        ...
        alturaDosTitulosDosItens = alturaDaSecaoDosItens + 21;
