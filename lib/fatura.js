...
const { formatarDinheiro } = require('./util/formatter')
...
var Fatura = (function() {
    ...
    Fatura.prototype.getValorOriginalFormatado = function() {
        return formatarDinheiro(this._valorOriginal || 0);
    };
    ...
    Fatura.prototype.getValorDoDescontoFormatado = function() {
        return formatarDinheiro(this._valorDoDesconto || 0);
    };
    ...
    Fatura.prototype.getValorLiquidoFormatado = function() {
        return formatarDinheiro(this._valorLiquido || 0);
    };
